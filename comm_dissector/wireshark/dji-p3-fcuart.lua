...
local FLYC_UART_CMD_TEXT = {
    ...
    [0x2d] = 'Set Limits',
    [0x2e] = 'Get Limits',
    [0x2f] = 'Set Alarm', -- Set Voltage Warnning
    [0x30] = 'Get Alarm', -- Get Voltage Warnning
    ...
    [0x82] = 'Upload WP Mission Info', -- Set WayLine Mission Length, Upload WayPoint Mission Msg
    [0x83] = 'Download WP Mission Info', -- Download WayLine Mission Info, Download WayPoint Mission Msg
    ...
    [0x87] = 'WP Mission pasue/resume', -- Pause Or Continue WayLine Mission
    ...
    [0x8a] = 'Start HP Mission With Info', -- Start HotPoint Mission With Info
    [0x8b] = 'Cancel HotPoint Mission', -- Cancel HotPoint Mission
    [0x8c] = 'HP Mission pasue/resume', -- HotPoint Mission Switch
    [0x8d] = 'TBD',
    [0x8e] = 'JoyStick',
    [0x8f] = 'Noe Mission pasue/resume', -- Noe Mission Pause Or Resume
    [0x90] = 'Start Follow With Info', -- Start Follow Me With Info
    [0x91] = 'App Request Follow Mission', -- or Cancel Follow Me Mission
    [0x92] = 'Follow Mission pasue/resume', -- Follow Me Mission Switch
    [0x93] = 'Send GPS Info',
    [0x94] = 'Start Noe Mission',
    [0x95] = 'Stop Noe Mission',
    [0x96] = 'HotPoint Mission Download',
    [0x97] = 'Start IOC',
    [0x98] = 'Stop IOC',
    [0x99] = 'HotPoint Reset Params',
    [0x9a] = 'HotPoint Reset Radius',
    [0x9b] = 'HotPoint Reset Camera',
    [0x9c] = 'Set WP Mission Idle Val', -- Set WayLine Flight Idle Value / Idle Speed
    [0x9d] = 'Get WP Mission Idle Val', -- Get WayLine Flight Idle Value / Idle Speed
    [0xa0] = 'Send AGPS Data',
    ...
    [0xb7] = 'Set And Get Redundancy IMU Index',
    [0xb8] = 'Redundancy Status',
    ...
    [0xe9] = 'Get Config Command Table Attribute', -- Set Flyforbid Data?
    [0xed] = 'Set Esc Echo',
    [0xee] = 'GoHome CountDown',
    [0xf0] = 'TBD',
    [0xf1] = 'Get Params By Index',
    [0xf2] = 'Set Params By Index',
    [0xf3] = 'Do Reset All Param', -- Reset Params By Index?
    [0xf4] = 'Push Params By Index',
    [0xf5] = 'Set Ver Phone',
    [0xf7] = 'Get Flyc Param Info By Hash',
    [0xf8] = 'Read Flyc Param By Hash', -- Get Single Param Value By Hash
    [0xf9] = 'Write Flyc Param By Hash', -- Set Single Param Value By Hash
    [0xfa] = 'Reset Flyc Params By Hash',
    [0xfb] = 'Read Flyc Params By Hash',
    [0xfc] = 'Write Flyc Params By Hash',
