...
function exec_mod_for_m0306 {
  ...
  ./arm_bin2elf.py -vvv -e -b 0x420000 --section .ARM.exidx@0x00d0e00:0 --section .bss@0x1ffe0000:0x60100 \
  ...
  set +x
  verify_changed_bytes_between_files 11 32 "${FWMODL}.orig.bin" "${FWMODL}.bin"
