...
# Tests hardcoder scripts by preparing a set of modded firmwares
...
WM610_FW_V01.04.00.10
WM610_FW_V01.05.00.30
WM610_FW_V01.06.00.40
WM610_FW_V01.07.00.90
WM610_FW_V01.08.00.92
WM610_FW_V01.08.01.00
WM610_FW_V01.11.01.50
)
declare -a FWPKG_LIST_UNUSED=(
WM610_FC350Z_FW_V01.09.01.40
WM610_FC550_FW_V01.08.00.92
)
...
function exec_mod_for_m0900 {
  ...
  # Verify by checking amount of changes within the file
  set +x
  if [[ "${FWMODL}" < "WM610_FW_V01.04.9999_m0900" ]]; then
...
for FWPKG in "${FWPKG_LIST[@]}"; do
  ...
  if [[ "${FWPKG}" > "WM610_FW_V01.04.9999" ]]; then
