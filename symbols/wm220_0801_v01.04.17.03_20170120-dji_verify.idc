...
#define id x
	...
	set_cmt	(0XD42,	"head_dig_len",	0);
	create_insn	(x=0XD42);
	op_stkvar	(x,	1);
	set_cmt	(0XD44,	"key",	0);
	set_cmt	(0XD46,	"signatr",	0);
	set_cmt	(0XD48,	"sig_len",	0);
	set_cmt	(0XD4C,	"header_digest",	0);
	create_insn	(x=0XD4C);
	op_stkvar	(x,	1);
	create_insn	(0XD66);
	create_insn	(x=0XD6C);
	...
	op_plain_offset	(x,	128,	0X7F94);
	create_insn	(0X1B24);
	set_name	(0X1B24,	"signalg_sub_1B24");
	create_insn	(0X1B2E);
	make_array	(0X1B54,	0X4);
	create_insn	(0X1B58);
	set_name	(0X1B58,	"signalg_sub_1B58");
	...
	op_stkvar	(x,	1);
	set_cmt	(0X1C44,	"refdata",	0);
	set_cmt	(0X1C46,	"outdata",	0);
	...
	create_insn	(0X1C70);
	set_name	(0X1C70,	"dji_image_auth");
	...
	op_stkvar	(x,	1);
	set_cmt	(0X1E56,	"refdata",	0);
	create_insn	(0X1E56);
	set_cmt	(0X1E58,	"outdata",	0);
	create_insn	(0X1E60);
	create_insn	(0X1E64);
...
static Functions_0(void) {
	...
	SetType(0X1B24, "void __cdecl signalg_sub_1B24(const uint32_t *refdata, uint32_t *outdata);");
	set_frame_size(0X1B24, 0X14, 0, 0);
	add_func    (0X1B58,0X1C64);
	set_func_flags(0X1B58,0x400);
	SetType(0X1B58, "void __cdecl signalg_sub_1B58(const uint32_t *inarr1, uint32_t *outarr, const uint32_t *inarr3, const uint32_t *inarr4);");
	set_frame_size(0X1B58, 0X70, 0, 0);
	add_func    (0X1C70,0X1E6E);
	set_func_flags(0X1C70,0x400);
	SetType(0X1C70, "signed int __cdecl dji_image_auth(uint32_t *key, uint8_t *signatr, int sig_len, uint8_t *header_digest, int head_dig_len);");
