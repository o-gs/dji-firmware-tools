...
keys = {
    ...
    "PUEK-2017-07":  bytes([ # PU Enc Key whitebox AES v1; published 2017-10-25 by Freek van Tienen
    ...
    "PUEK-2017-01": bytes([ # PU Enc Key Old Non-whitebox v1; published 2017-06-27 by Freek van Tienen
    ...
    "TRIE":  bytes([ # TRI Encryption key; published 2021-03-26 by Felix Domke
        0xf1, 0xe6, 0x30, 0x6d, 0x6c, 0x84, 0xf0, 0x9e, 0xd5, 0x59, 0x0f, 0x94, 0x73, 0xb1, 0x55, 0x26
    ]),
    "TKIE":  bytes([ # TKI Encryption key; published 2021-03-26 by Felix Domke
    ...
    "PRAK-2017-01":  bytes([ # PR Auth Key v1; published 2017-06-27 by Freek van Tienen
    ...
    "RRAK":  bytes([ # RR Auth Key v1; published 2017-06-27 by Freek van Tienen
    ...
    "GFAK":  bytes([ # GF Auth Key v1; published 2017-06-27 by Freek van Tienen
    ...
    "SLAK": # Slack community AK; generated 2018-01-19 by Jan Dumon
"""-----BEGIN PRIVATE KEY-----
