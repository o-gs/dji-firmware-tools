...
keys = {
    # Encryption keys
    "RREK":  bytes([ # First version; published 2017-06-27 by Freek van Tienen
        0x37, 0xD6, 0xD9, 0x13, 0xE5, 0xD0, 0x80, 0x17, 0xE5, 0x12, 0x15, 0x45, 0x0C, 0x1E, 0x16, 0xE7
    ]),
    "RIEK":  bytes([ # First version; published 2017-06-27 by Freek van Tienen
        0xF1, 0x69, 0xC0, 0xF3, 0x8B, 0x2D, 0x9A, 0xDC, 0x65, 0xEE, 0x0C, 0x57, 0x83, 0x32, 0x94, 0xE9
    ]),
    "RUEK":  bytes([ # First version; published 2017-06-27 by Freek van Tienen
        0x9C, 0xDA, 0xF6, 0x27, 0x4E, 0xCB, 0x78, 0xF3, 0xED, 0xDC, 0xE5, 0x26, 0xBC, 0xEC, 0x66, 0xF8
    ]),
    "DRAK":  bytes([ # First version; published 2017-06-27 by Freek van Tienen
